...
data1 <- readxl::read_xlsx("2_data/TTSH_small molecular quantification.xlsx", sheet = 1)
data2 <- readxl::read_xlsx("2_data/TTSH_small molecular quantification.xlsx", sheet = 2)
