...
dir.create("3_data_analysis/5_different_nmr_bucket", showWarnings = FALSE)
setwd("3_data_analysis/5_different_nmr_bucket")
...
openxlsx::write.xlsx(nmr_data@variable_info,
                     file = "variable_info.xlsx",
                     asTable = TRUE)

openxlsx::write.xlsx(
  nmr_data@variable_info %>% dplyr::filter(p_value < 0.05),
